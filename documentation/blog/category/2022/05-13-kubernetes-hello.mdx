...
import KubeControllersCerts from '@site/blog-draft/kubernetes-the-hard-way/components/controllerManager/certs.mdx'
import KubeSchedulerCerts   from '@site/blog-draft/kubernetes-the-hard-way/components/scheduler/certs.mdx'
