...
<ul>
  ...
  <li>`items.$ruleName.sg_from` - {DICTIONARY['v1.13.0'].sg.short}</li>
  <li>`items.$ruleName.sg_to` - {DICTIONARY['v1.13.0'].sg.short}</li>
...
<ul>
  ...
  <li>
    `items.$ruleName`:
    <Restrictions data={RESTRICTIONS['v1.13.0'].itemsRuleName_s2s} />
  </li>
  <li>
