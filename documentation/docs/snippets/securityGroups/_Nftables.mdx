...
<ul>
  ...
  <li>`$TypeList` - {DICTIONARY['v1.13.0'].icmpTypes.short}</li>
  <li>`$Log` - {DICTIONARY['v1.13.0'].log.short}</li>
  <li>`$Counter` - {DICTIONARY['v1.13.0'].nftCounter.short}</li>
  <li>`$Verdict` - {DICTIONARY['v1.13.0'].nftRuleVerdict.short}</li>
</ul>
