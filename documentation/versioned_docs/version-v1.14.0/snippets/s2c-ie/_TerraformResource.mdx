...
<ul>
  ...
  <li>`items.$ruleName.cidr` - {DICTIONARY['v1.13.0'].cidrSet.short}</li>
  <li>`items.$ruleName.sg_name` - {DICTIONARY['v1.13.0'].sgLocal.short}</li>
...
<ul>
  ...
  <li>
    `items.$ruleName`:
    <Restrictions data={RESTRICTIONS['v1.13.0'].itemsRuleName_s2c_ie} />
  </li>
  <li>
