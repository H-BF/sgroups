...
<ul>
  <li>`$node.name` - {DICTIONARY['v1.13.0'].sg.short}</li>
  <li>`$node.logs` - {DICTIONARY['v1.13.0'].log.short}</li>
  <li>`$node.trace` - {DICTIONARY['v1.13.0'].trace.short}</li>
  <li>`$node.networks` - {DICTIONARY['v1.13.0'].networkNames.short}</li>
  <li>`$node.defaultAction` - {DICTIONARY['v1.13.0'].defaultAction.short}</li>
</ul>
