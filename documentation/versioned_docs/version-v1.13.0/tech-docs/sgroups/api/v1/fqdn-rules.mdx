...
<ul>
  <li>`sgFrom[]` - {DICTIONARY['v1.13.0'].sgroupSet.short}</li>
</ul>
...
<ul>
  ...
  <li>`$node.rules[].FQDN` - {DICTIONARY['v1.13.0'].fqdn.short}</li>
  <li>`$node.rules[].sgFrom` - {DICTIONARY['v1.13.0'].sg.short}</li>
  ...
  <li>`$node.rules[].protocols` - {DICTIONARY['v1.13.0'].l7ProtocolList.short}</li>
</ul>
