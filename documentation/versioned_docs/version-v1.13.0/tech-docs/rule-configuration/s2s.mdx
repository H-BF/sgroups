...
import TerraforModule from '../../snippets/s2s/_TerraformModule.mdx'
import TerraformResource from '../../snippets/s2s/_TerraformResource.mdx'
import Nftables from '../../snippets/s2s/_Nftables.mdx'
