...
<ul>
  ...
  <li className="text-justify">`rules.$traffic[].sgroupSet[]` - {DICTIONARY['v1.13.0'].sgroupSet.short}</li>
  ...
  <li className="text-justify">`rules.$traffic[].access.$transport.log` - {DICTIONARY['v1.13.0'].log.short}</li>
