...
//	extractF    func(p *exprParserCtx, exp expr.Any) error
//
//	rule *nftablesRule
//
...
//)
//
//func (p *exprParserCtx) parseLookup(lookup *expr.Lookup, prevExpr expr.Any) {
...
//}
//
//func (p *exprParserCtx) parseCmp(cmp *expr.Cmp, prevExpr expr.Any) {
//	switch p.extractData {
...
//}
//
//func (p *exprParserCtx) parseMeta(_ *expr.Meta) {
//	p.extractData = parserExtractMeta
//}
//
//func (p *exprParserCtx) parsePayload(payload *expr.Payload) {
...
//}
//
//func extractIPv4(p *exprParserCtx, exp expr.Any) error {
...
//
//	p.extractData = parserExtractFunction
//	p.extractF = func(p *exprParserCtx, exp expr.Any) error {
//		defer func() {
...
//}
//
//func extractIPv6(p *exprParserCtx, exp expr.Any) error {
//	payload, ok := exp.(*expr.Payload)
//	if !ok {
//		return errors.Errorf("expected expr.Payload but got: %T", exp)
//	}
...
//}
//
//func noopExtract(_ *exprParserCtx, _ expr.Any) error {
//	return nil
//}
